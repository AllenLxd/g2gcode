...
class ProductOrder extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['product_model','number','factory_name','factory_en_name','order_time','price','username','lamp_bead_code','ic_number','lamp_number','lamp_wastage_rate'], 'required'],
        	[['jet_coding','factory_name','lamp_bead_code','remark','progress'],'string'],
        	[['price'],'number'],
        	[['plan_delivery_time','order_time','ic'], 'safe'],
